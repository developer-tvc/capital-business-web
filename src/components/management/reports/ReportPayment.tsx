...
import { reportPaymentTableHead } from '../../../utils/data';
            ...
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto border">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loans?.length > 0 ? (
                  loans?.map(
                    (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{customer_id || 'N/A'}</td>
                        <td className="whitespace-nowrap px-6 py-4">
                          {payment_date || 'N/A'}
                        </td>
                        <td className="whitespace-nowrap px-6 py-4">
                  ...
                  <tr>
                    <td
                      colSpan={reportPaymentTableHead.length}
