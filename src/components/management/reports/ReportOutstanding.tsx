...
import { reportOutstandingTableHead } from '../../../utils/data';
...
const ReportOutstanding = () => {
  ...
  } = usePagination(outStandingDueGetApi);
  ...
  return (
    <>
      ...
      <Header title="Outstanding Report">
        <div className="flex gap-4">
          <div>
            <CSVLink
              data={transactionData}
              filename="ReporOutstanding.csv"
              target="_blank"
              onClick={event => {
          ...
          {(isLaptop || isTablet) && (
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto border">
              <thead className="bg-[#D3D3D3]">
                <tr>
                  {reportOutstandingTableHead.map(
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loans?.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={reportOutstandingTableHead.length}
