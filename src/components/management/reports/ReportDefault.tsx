...
import { reportDefaultTableHead } from '../../../utils/data';
...
const ReportDefault = () => {
  ...
  } = usePagination(defaultUserGetApi);
  ...
  return (
    <>
      ...
      <Header title="Default Report">
        <div className="flex gap-4">
          <div>
            <CSVLink
              data={transactionData}
              filename="ReportDefault.csv"
              target="_blank"
              onClick={event => {
            ...
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto border">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loans?.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={reportDefaultTableHead.length}
