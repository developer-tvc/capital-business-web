...
import { reportContractExpiringTableHead } from '../../../utils/data';
...
const ReportContractExpiring = () => {
  ...
  } = usePagination(expiringContractsGetApi);
  ...
  return (
    <>
      ...
      <Header title="Expiring Contract Report">
        <div className="flex gap-4">
          <div>
            <CSVLink
              data={transactionData}
              filename="ReportContractExpiring.csv"
              target="_blank"
              onClick={event => {
          ...
          {(isLaptop || isTablet) && (
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto border">
              <thead className="bg-[#D3D3D3]">
                <tr>
                  {reportContractExpiringTableHead.map(
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loans?.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={reportContractExpiringTableHead.length}
...
export default ReportContractExpiring;
