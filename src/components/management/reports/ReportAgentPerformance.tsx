...
import { reportAgentPerformanceTableHead } from '../../../utils/data';
import {
  convertDateString,
...
const ReportAgentPerformance = () => {
  ...
  } = usePagination(agentPerformanceReportGetApi);
  ...
  return (
    <>
      ...
      <Header title="Field Agent Performance Report">
        <FormProvider {...methods}>
          ...
          <div className="pl-4">
            <CSVLink
              ...
              filename={`ReportAgentPerformance.csv ${date_from} - ${date_to}`}
              target="_blank"
              onClick={event => {
                downloadData();
          ...
          {(isLaptop || isTablet) && (
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto border">
              <thead className="bg-[#D3D3D3]">
                <tr>
                  {reportAgentPerformanceTableHead.map(
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loans?.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={reportAgentPerformanceTableHead.length}
...
export default ReportAgentPerformance;
