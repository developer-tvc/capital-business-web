          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcrumb-box">
                <h1 className="page-title">Consumer Duty Statement</h1>
                <nav>
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item"><NavLink to={"/"}> Home</NavLink></li>
                    <li className="breadcrumb-item active" >Consumer Duty Statement</li>
                  </ol>
                </nav>
              </div>
            </div>
...
export default DutystatementBanner
