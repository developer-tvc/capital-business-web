...
const DataprotectionpolicyBanner = () => {
  return (
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcrumb-box">
                <h1 className="page-title">Data Protection Policy</h1>
                <nav>
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item"><NavLink to={"/"}> Home</NavLink></li>
                    <li className="breadcrumb-item active" >Data Protection Policy</li>
                  </ol>
                </nav>
              </div>
            </div>
...
export default DataprotectionpolicyBanner
